          ...
          >
            <div className={styles.firstCar}>
              ...
              <div className={styles.bodywork}>
                <img src="/myResume/images/tasks/car2.png" alt="Кузов машины" />
              </div>
              <div className={styles.squirell}>
                <img src="/myResume/images/tasks/car4.png" alt="Белка" />
              </div>
              <div className={styles.wheels}>
                <img src="/myResume/images/tasks/car3.png" alt="Левое колесо" />
                <img
                  src="/myResume/images/tasks/car3.png"
                  alt="Правое колесо"
                />
              </div>
            </div>
            <div className={styles.secondCar}>
              <div className={styles.bodywork2}>
                <img src="/myResume/images/tasks/car1.png" alt="Кузов машины" />
                <p>Приехали)</p>
              </div>
              <div className={styles.squirell2}>
                <img src="/myResume/images/tasks/car5.png" alt="Белка" />
              </div>
            </div>
          </section>
          <section
